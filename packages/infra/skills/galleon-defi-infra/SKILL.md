...
After onboarding, hand the verified chain/account/capabilities to the requested LP, Hyperliquid or data workflow if present. This pack supplies infrastructure procedures and diagnostics; it does not execute a trade, fund a wallet or implement a signer.
