...
npx --package galleon-defi-data-skills@0.1.0 defi-data-skills catalog
```
...
Read [the skill](skills/galleon-defi-data/SKILL.md) or its [provider setup](skills/galleon-defi-data/references/providers.md), [methodology](skills/galleon-defi-data/references/methodology.md), and [diagnostic](skills/galleon-defi-data/references/diagnostic.md) references.

## Verify public data

```bash
npx --package galleon-defi-data-skills@0.1.0 defi-data-skills price-check --provider coingecko --id bitcoin
npx --package galleon-defi-data-skills@0.1.0 defi-data-skills price-check --provider defillama --id bitcoin
```
