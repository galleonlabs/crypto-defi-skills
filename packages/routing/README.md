...
Compare swaps and bridges and track cross-chain settlement. One portable skill, independently installable in Hermes, Codex, Claude Code and other Agent Skills clients.

## Install

```bash
npx skills add galleonlabs/crypto-defi-skills --skill galleon-defi-routing
npx --package galleon-defi-routing-skills@0.1.0 defi-routing-skills catalog
```
