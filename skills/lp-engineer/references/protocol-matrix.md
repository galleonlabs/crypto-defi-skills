...
|---|---|---|---|---|---|
| Position | ERC-20 LP | NFT | Manager-defined position | ERC-20 LP | NFT, optionally gauge-held |
| Range | Full | Ticks | Ticks | Full, stable or volatile invariant | Ticks |
...
| Fees | Embedded in reserve share | Separately owed | Hook and manager aware | Verify fee route | Can differ when gauge-staked |
...
| Lifecycle | Add, remove | Mint, increase, decrease, collect, burn | Manager actions and settlement | Add, stake, claim, unstake, remove | Mint, stake, claim, unstake, decrease, collect, burn |
